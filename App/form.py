...
model = pickle.load(open('../notebooks/finalized_model2.sav', 'rb'))

title = Image.open('../imagenes/bandera_galicia.jpg')

title2 = Image.open('../imagenes/logo_sergas.png')

col1, col2 = st.columns([1, 5])

with col1:
    st.image(title2, width = 100)
with col2:
    st.image(title, width = 300)
    
descrip = st.write("Esta es una aplicación diseñada para uso médico. No la utilice sin la supervisión médica pertinente")
